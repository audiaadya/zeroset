        ...
        <header className="mb-6">
          <div className="flex items-center gap-2">
            ...
            {selected.status === 'solved' ? (
              ...
              <span className="flex items-center gap-1 rounded border border-red-500/40 bg-red-500/10 px-2 py-0.5 font-mono text-[9px] uppercase tracking-wider text-cream-200">
        ...
        <div className="space-y-4">
          ...
          {selected.status === 'solved' ? (
            ...
            <div className="rounded-xl border border-ink-700 bg-ink-850/50 p-5">
              ...
              />
              {error && (
                <div className="mt-2 flex items-start gap-2 rounded-md border border-red-500/30 bg-red-500/10 px-3 py-2 text-xs text-cream-200">
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      <header className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full border border-red-500/30 bg-red-500/10 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.2em] text-cream-200">
            ...
            >
              <div className="flex items-center justify-between gap-3">
                ...
                {b.status === 'solved' ? (
                  ...
                  <span className="flex items-center gap-1 rounded border border-red-500/40 bg-red-500/10 px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-wider text-cream-200">
