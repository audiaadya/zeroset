        ...
        <header className="mb-6">
          <div className="flex items-center gap-2">
            ...
            {selected.status === 'spotlight' && (
              <span className="flex items-center gap-1 rounded border border-amber-400/40 bg-amber-400/10 px-2 py-0.5 font-mono text-[9px] uppercase tracking-wider text-cream-200">
          ...
          <div className="flex items-center gap-2">
            ...
            {isHost && selected.status !== 'spotlight' && (
              <button
                ...
                className="flex items-center gap-1 rounded border border-amber-400/40 bg-amber-400/10 px-3 py-1.5 text-xs uppercase tracking-wider text-cream-200 hover:bg-amber-400/20"
              >
          ...
          {prompts.map((p) => (
            ...
            >
              <div className="flex items-center justify-between gap-3">
                ...
                {p.status === 'spotlight' && (
                  <span className="flex items-center gap-1 rounded border border-amber-400/40 bg-amber-400/10 px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-wider text-cream-200">
