...
export default function HomePage({ navigate }: Props) {
  ...
  return (
    <div>
      {/* Nonprofit banner */}
      <div className="border-b border-accent-400/20 bg-ink-900 px-4 pb-3 pt-16 text-center font-mono text-xs uppercase tracking-widest text-accent-300">
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <button
            ...
            className={`focus-ring flex items-center gap-1.5 rounded-md border px-3 py-1.5 text-xs transition ${
              mockMode
                ? 'border-amber-500/50 bg-amber-500/15 text-cream-200'
      ...
      <section className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
        <div className="flex flex-col items-center gap-4 rounded-lg border border-red-500/40 bg-red-500/5 p-6 text-center sm:flex-row sm:justify-between sm:text-left">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-red-500/40 bg-red-500/10 text-red-400">
              <Heart className="h-5 w-5" />
            </div>
            <div>
              <h3 className="font-serif text-lg italic text-ink-50">Support ZeroSet</h3>
              <p className="mt-0.5 text-sm text-ink-400">
                We're a 501(c)(3) nonprofit — all donations are tax-exempt.
              </p>
            </div>
          </div>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex shrink-0 items-center gap-2 rounded-md border border-red-500/50 bg-red-500/10 px-5 py-2.5 text-sm font-semibold text-cream-200 transition hover:bg-red-500/20"
          >
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 text-center sm:px-6">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-3">
          ...
          <button
            onClick={() => navigate('/sudden-death')}
            className="focus-ring flex items-center gap-2 rounded-md border border-amber-500/50 bg-amber-500/10 px-4 py-2 text-sm font-semibold text-cream-200 transition hover:bg-amber-500/20"
          >
