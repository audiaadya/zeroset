  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      <header className="mb-8">
        <span className="inline-flex items-center gap-2 rounded-full border border-accent-500/30 bg-accent-500/10 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.2em] text-cream-200">
            ...
            return (
              <div key={p.id} className="rounded-xl border border-ink-700 bg-ink-850/50 p-5">
                <div className="flex items-start justify-between gap-3">
                  ...
                  {submitted && lockedOut && (
                    <span className="flex items-center gap-1 rounded border border-red-500/40 bg-red-500/10 px-2 py-1 font-mono text-[10px] uppercase tracking-wider text-cream-200">
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="focus-ring flex items-center gap-1.5 rounded-md border border-accent-500/50 bg-accent-500/15 px-4 py-2 text-sm font-semibold text-cream-100 hover:bg-accent-500/25 disabled:opacity-50"
                      >
