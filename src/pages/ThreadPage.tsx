      ...
      {loading ? (
        ...
        <>
          ...
          <div className="mt-8">
            ...
            {error && (
              <div className="mt-3 flex items-start gap-2 rounded-md border border-red-500/30 bg-red-500/10 px-3 py-2 text-xs text-cream-200">
                <AlertCircle className="mt-0.5 h-3.5 w-3.5 shrink-0" />
                <span>{error}</span>
              </div>
            )}
            ...
            <div className="mt-3">
              ...
              {showEditor && (
                <div className="mt-3">
                  ...
                  />
                  {error && (
                    <div className="mt-2 text-xs text-cream-200">{error}</div>
                  )}
                </div>
              )}
            </div>
