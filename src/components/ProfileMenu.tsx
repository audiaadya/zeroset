  ...
  if (!user) {
    return (
      <div className="hidden items-center gap-2 md:flex">
        <button
          onClick={onSignIn}
          className="focus-ring rounded-md px-3 py-1.5 text-sm text-white transition hover:text-white"
        >
          Sign in
        </button>
        <button
          onClick={onSignUp}
          className="focus-ring rounded-md border border-accent-400 bg-accent-400/15 px-3 py-1.5 text-sm font-semibold text-white transition hover:bg-accent-400/25"
        >
          Join
        </button>
      </div>
  ...
  return (
    <button
      ...
      className={`focus-ring flex w-full items-center gap-2.5 rounded-md px-3 py-2 text-left text-sm transition ${
        danger ? 'text-white hover:bg-red-500/10 hover:text-red-300' : 'text-white hover:bg-ink-800 hover:text-white'
      }`}
    >
